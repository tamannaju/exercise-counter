    ...
    def generate_frames(self):
        ...
        while True:
            with self.lock:
                ...
                # Run pose detection
                results = self.pose.detect(frame)
                ...
                if results.pose_landmarks:
                    ...
                    p1 = lm[self.joint_ids[0]]
                    p2 = lm[self.joint_ids[1]]
                    p3 = lm[self.joint_ids[2]]
                ...
                cv2.putText(
                    frame,
                    f"{self.exercise_name}: {self.counter.count}",
                    (10,55),
                    cv2.FONT_HERSHEY_SIMPLEX,
                    1.2,
                    (0,255,255),
